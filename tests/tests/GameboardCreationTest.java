...
public class GameboardCreationTest extends TestCase{
	...
	//this function for create game board
    ...
    public void testGameboardLayout() {
        assertEquals(new Dimension(1, 0), GameBoardUtil.calculateDimension(6));
        assertEquals(new Dimension(3, 2), GameBoardUtil.calculateDimension(14));
    }
}
